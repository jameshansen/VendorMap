...
<body style="font-family: Arial, sans-serif; color:#1b2430; line-height:1.5;">
    ...
    <p>Your {{ config('vendormap.name', 'VendorMap') }} account has been approved. You can now sign in and book a table
       for any open event. Here are your account details:</p>
